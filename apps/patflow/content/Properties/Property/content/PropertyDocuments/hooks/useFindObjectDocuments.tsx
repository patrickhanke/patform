...
const paramsHandler = (id?: string, type?: string) => {
	...
	if (id && type === 'task') return {'object': {'_eq': id}, _and: {'type': {'_eq': 'task'}}};
	if (id && type === 'object') return {'object': {'_eq': id}, _and: {'type': {'_eq': 'object'}}};
	return undefined;
};  

const useFindObjectsDocuments = ({id, type}: {id: string, type: string}) => {
