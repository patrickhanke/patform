...
const CreatePropterty = ({
    ...
    createObject: (data: typeof initialData) => void;
    isOpen: boolean;
}) => {
    ...
    return (
        ...
        >
            <div className={styles.create_property_container}>
                <div>
                    <p>Hier kann ein neues Objekt angelegt werden werden.</p>
                    <form>
                        <div>
                            <label htmlFor="text">Name des Objekts</label>
                            <input
                                id="text"
                                type="text"
                                onChange={e =>
