...
import { ErrorMessage, Holiday, HolidayTemplate, Record, RecordTimeSettings, SwitchButton } from '@types';
				...
				<div className={styles.create_record_switch_buttons}>
					<div>
						...
						<SwitchButtons
							...
							changeHandler={(state: SwitchButton) => setYear(state.value as number)}
