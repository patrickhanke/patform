import React, {useState, useEffect, Dispatch, SetStateAction, FC, useContext} from 'react';
...
const CreateStaffMember: FC<CreateStaffMemberProps> = ({workers = [], setIsOpen, isOpen, refetch}) => {
	...
	return (
		<SlideIn 
			...
			secondaryContent={<EditStaffSecondaryData staffMember={worker} setStaffMember={setWorker} />}
			showSecondaryContent={true}
		>
			<EditStaffData staffMember={worker} setStaffMember={setWorker} errors={errors} roles={roleData && roleData.objects.find_Role.results} />
		</SlideIn>
	);
};
