...
const RecordTimeDisplay = ({setCurrentIndex, day, currentIndex, index} : RecordTimeDisplayProps) => {
	...
	return (
		<div className={isTime ?  clsx(styles.content_button, 'content_element') : 'content_element'} data-active={index === currentIndex} onClick={() => isTime && setCurrentIndex(index)} >
				...
				{isTime ?
					<>
						...
						<div className='time_display_element'>
							...
							<div className='time_display_element_content'>{convertMillisecondsToString(day.time?.pause)}</div>
						</div>
						<div className='time_display_element'>
							<div className='label'>Arbeitszeit</div>
							<div className='time_display_element_content'>{day.time?.duration && convertMillisecondsToString(day.time?.duration - day.time?.pause)} Stunden</div>
						</div>
					</> 
					:
					<div className='time_display_element'>
