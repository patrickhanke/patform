        ...
        <div>
          <div className="vertical_container">
            {record.year >= new Date().getFullYear() && (
              <InfoBox
                color="red"
                text=" Die Änderungen an der Zeiterfassung werden sofort übernommen und beeinflussen die Saldo Berechnung des laufenden Jahres."
              />
            )}

            <h3>Start des neuen Eintrags</h3>
            <p>
              Wenn eine neue Zeiterfassung für das laufende Jahr erstellt werden
              soll, dann beginnen die neuen Einstellungen zum angebebenen Datum.
            </p>
            <Select
              options={dateOptions}
