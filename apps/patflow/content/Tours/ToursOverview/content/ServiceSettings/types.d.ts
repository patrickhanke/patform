...
export type UpdateHandler = (T: {serviceId: string, updateObject: {[key: string]: any}}) => void

export type UseServiceSettingsTableColumns = (T: {updateHandler: UpdateHandler}) => ColumnDef<Service>[]
