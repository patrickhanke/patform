...
const CreateService: FC<CreateServiceProps> = ({createService, setCreateService, refetch}) => {
    ...
    useEffect(() => {
        ...
        if (!service.name) {
            errorArray.push({message: 'Bitte geben Sie einen Namen ein', id: 'no_name', key: 'no_name'})
        }
