...
const ServiceSettings: FC<ServiceSettingsProps> = ({projectId, createService, setCreateService}) => {
    ...
    return (
        <div className="content_element no_padding">
            ...
            <CreateService createService={createService} setCreateService={setCreateService} refetch={refetch} />
        </div>
    )
}
