        ...
        <div>
          ...
          {date.type.value === "single" && (
            <div className={clsx("info_container", "margin_top")}>
              <p>
                {" "}
                Hier kann für eine Aufgabe ein individueller Termin festgelegt
                werden.{" "}
              </p>
            </div>
          )}
          {date.type.value === "multi" && (
            <div className={clsx("info_container", "margin_top")}>
              <p>
                {" "}
                Hier können indiviuelle Termine für eine Aufgabe festgelegt
                werden.{" "}
              </p>
            </div>
          )}
        ...
        <div>
          {date.type.value === "single" && (
            <SingleDateSelectInterface
              ...
              onChange={(newDate: DateObjectWithNextDates) => setDate(newDate)}
            />
          )}
          {date.type.value === "multi" && (
