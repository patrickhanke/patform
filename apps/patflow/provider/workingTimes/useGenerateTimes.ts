        ...
        days.forEach((day) => {
          ...
          if (day.type === "work" && day?.time) {
            ...
            set(
              ...
              (periodObject.time_overview.time.value += day.time.duration),
            );
            set(
              periodObject,
              "time_overview.breaks.value",
              (periodObject.time_overview.breaks.value += day.time.pause),
            );
            set(
              periodObject,
              "time_overview.saldo.value",
          ...
          surchargesForDay.forEach((surcharge) => {
            ...
            if (surcharge.type === "time") {
              ...
              if (existingValue) {
                ...
                set(periodObject, `surcharges.${surcharge.objectId}`, {
