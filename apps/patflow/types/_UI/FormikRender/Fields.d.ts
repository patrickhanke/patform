...
export type Field =
  ...
  | (FieldBasic & { type: "image" | "file"; value: object; dataType: object })
  | (FieldBasic & { type: "time_input"; value: number; dataType: number })
  ...
  | (FieldBasic & {
      type: "pointerselect";
      value: string | object;
      dataType: { __type: "Pointer"; className: string; objectId: string };
      options: {
