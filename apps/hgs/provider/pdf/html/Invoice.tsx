	...
	return (
		<html lang="de">
			<head>
				...
				<Head>
					<script key='1234' src="https://unpkg.com/pagedjs@0.2.0/dist/paged.polyfill.js"></script>
					<script key='3434' src="https://bytescout-com.s3.us-west-2.amazonaws.com/files/cloudapi-templates/paged.polyfill-020.js"></script> 
				</Head>
