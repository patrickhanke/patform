...
import SiteHeader from '../surfaces/SiteHeader';
		...
		<>
			...
			<div className={clsx('site_content')}>
				<div className={styles.tallies_container}>
					{tallies && tallies.map((tally: TallyTypes.Tally) => <Tally key={tally.objectId} tallyName={tally.name} tallyId={tally.objectId} />) }
				</div>
			</div>
		</>
	);
