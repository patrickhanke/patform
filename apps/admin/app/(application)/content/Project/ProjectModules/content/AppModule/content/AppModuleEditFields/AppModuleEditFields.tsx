...
const AppModuleEditFields = ({moduleId, initialFields}: AppModuleEditFieldsProps) => {
    ...
    return (
        <div>
            ...
            <SlideIn
                ...
                secondaryContent={<AppModuleEditField field={findActiveField(activeField)} setFields={setFields} />}
            ...
            >
                ...
                <div>
                    <DnDDisplay<Field[]>
                        items={sortItemsByPosition(fields) as Field[] || []}
                        ItemComponent={({item}) => (<AppModuleField field={item as Field} setActiveField={setActiveField} />)}
                        objectClass='Module'
