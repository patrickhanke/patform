...
const Login = async ({params}: {params: {project_path: string}}) => {
    ...
    if (response.success === false) {
        return <p>Projekt nicht gefunden. Falls es sich um einen gültigen Link hanelt, wenden Sie sich bitten an <a href='mailto:info@patwork.net'>info@patwork.net </a></p>
    }
