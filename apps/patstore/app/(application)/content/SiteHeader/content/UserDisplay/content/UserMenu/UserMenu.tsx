...
const UserMenu: FC<UserMenuProps> = ({user, setUserMenu, setUserSettings, setUserPassword, setSelectProject}) => {
        ...
        <div>
            <div className='user_menu_header'>
                <div className='user_menu_portrait_container'>
                    {user.portrait ?
                        <img
                            src={getImageUrl({filePath: user.portrait, width: 80, height: 80})}
                            height={'40px'}
                            width={'40px'}
                            alt={user.label}
                        />
                    :
                        <Icon type='circle-user-round' size={40} strokeWidth={2} color={'#999999'} />
                    }
                </div>
                <div>
                    <h4>{user.label}</h4>
