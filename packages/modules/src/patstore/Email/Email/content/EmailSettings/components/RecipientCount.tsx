...
const RecipientCount: FC<RecipientCountProps> = ({
	...
	const recipientListId = resolveRecipientListId(
			...
			{recipients && (
				...
				>
					<div className="flex col gap-md">
						{!recipientListId ? (
							<p>
								Keine Empfängerliste ausgewählt. Bitte wählen
								Sie in den Einstellungen eine Liste aus.
							</p>
						) : recipients.length > 0 ? (
							<>
								{suppressedRecipients.length > 0 && (
									<p>
										{suppressedRecipients.length} Empfänger
										sind unterdrückt und nicht enthalten.
									</p>
								)}
								<Table
									columns={columns}
