...
const findSubgroup = (groups: CompetitionGroup[], subgroupId?: string) => {
	if (!subgroupId) {
		return undefined;
	}
...
export const signupLabel = (
	signup: CompetitionSignup | undefined,
...
export const getTeamLabel = (
	...
	team1: CompetitionTeamLabel;
	team2: CompetitionTeamLabel;
	referee: CompetitionTeamLabel;
} => {
	const resolveSlot = (
		groupId?: string,
		index?: number,
