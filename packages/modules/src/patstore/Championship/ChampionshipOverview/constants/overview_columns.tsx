...
import { ApolloRefetch, ChampionshipClass } from "@repo/types";

export const getChampionshipOverviewColumns = (
	refetch: ApolloRefetch
): ColumnDef<ChampionshipClass>[] => [
	{
	...
	},
	{
		accessorFn: (row) => (
			<div className="button_container">
				<IconButton
					isLink
					link={`/championships/${row.objectId}`}
					icon="link"
				/>
