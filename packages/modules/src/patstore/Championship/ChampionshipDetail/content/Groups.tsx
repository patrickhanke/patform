...
const Groups: FC<ChampionshipTabProps> = ({
	championship,
	related,
	onUpdate,
	loading
	...
	const saveGroups = (
		groups: ChampionshipTabProps["championship"]["groups"],
		feedback: string
		...
		<div className="flex col a-st gap-sm">
			<div className="flex row a-ce gap-sm">
				...
				<CreateButton
					...
					onClick={() => {
						saveGroups(
							[...championship.groups, createGroup({ name })],
							"Gruppe erstellt"
						);
						setName("Neue Gruppe");
					}}
