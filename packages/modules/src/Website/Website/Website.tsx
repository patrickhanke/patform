...
const Website = () => {
	...
	const {data: moduleData} = useQuery(generateGraphQLQuery({type: 'get', objectName: 'Module', fields: ['settings', 'objectId']}),
		...
		return (
			...
			>
				{activeState.value ==='settings' && 
					<WebsiteSettings settings={module.settings} moduleId={currentModule.objectId} />
				}
