...
import { Page, RenderFilters, Separator, Table, useCreateColumns } from '@repo/ui';
...
const DownloadsOverview = () => {
	...
	const {downloads, refetch} = useFindDownload({moduleId: currentModule.objectId, filters});
	...
	return (
		...
		>
			<RenderFilters 
				...
				initialFilters={[]} 
				fields={[
					{type: 'input', key: 'title', operator: '_text',  placeholder: 'Status...'}
				]}
			/>
