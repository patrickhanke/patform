			...
			setTask((draft) => {
				Object.keys(initialData).forEach((key) => {
					draft[key as keyof CreateTaskType] =
						initialData[
							key as keyof CreateTaskProps["initialData"]
						];
				});
			});
		}
	...
	return (
		<>
			...
			>
				...
				>
					<div className="main_create_task_inputs_container">
						<div className="create_task_inputs_container">
							<TextInput
								label="Aufgabe"
								id={"title"}
								onChange={(value) =>
