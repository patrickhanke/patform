    ...
    <div className={clsx("content_element", styles.surcharge_container)}>
      <div className={styles.surcharge_content}>
        ...
        <div className="button_container" style={{ width: "120px" }}>
          <label className="button_container no_margin">Typ:</label>
          <p>
            {
              surcharge_types.find((type) => type.value === surcharge.type)
                ?.label
            }
          </p>
        </div>
        <div className="button_container">
          <label className="button_container no_margin">Status:</label>
