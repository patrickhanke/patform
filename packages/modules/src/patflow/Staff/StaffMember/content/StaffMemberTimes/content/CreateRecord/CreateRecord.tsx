      ...
      holidayTemplateData && [
        {
          ...
          select_options: holidayTemplateData?.objects.findTemplate.results.map(
  ...
  const renderFields = useMemo(
    () =>
      ...
      holidayTemplateData && [
        {
          label:
            "Anfangssaldo in Stunden zu Beginn der Zeiterfassung (in Stunden)",
          name: "initial_saldo",
          type: "number",
        ...
        <div className={styles.create_record_switch_buttons}>
          <div>
            ...
            <SwitchButtons
              ...
              currentStates={
                buttonStates.find((value) => value.value === year) as {
                  value: number;
                  label: string;
                }
              }
          ...
          <div>
            <h3>
              Zeitangaben des bestehenden Eintrags übernehmen (Urlaube und
              Überstunden)
            </h3>
            <Divider size="small" showLine={false} />
            <SwitchButtons
              ...
              currentStates={
                adobtButtonOptions.find((value) => value.value === adobt) as {
                  value: boolean;
                  label: string;
                }
              }
            ...
            <>
              ...
              <Form
                ...
                valueReturnFunction={(values) => {
                  setNextRecord({
                    ...nextRecord,
                    time_settings: values as RecordTimeSettings,
                  });
                }}
              />
            </>
