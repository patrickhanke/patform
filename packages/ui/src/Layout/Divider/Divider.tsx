...
const Divider = ({
  ...
  if (type === "block") {
    return (
      <div
        className={styles.divider_block}
        data-size={size}
        data-showline={showLine}
      >
        {text && (
          <div className={styles.divider_block_text_container}>
            <h4>{text}</h4>
          </div>
        )}
        {getDate(date) && (
  ...
  return (
    <div className={styles.divider} data-size={size} data-showline={showLine}>
      ...
      {getDate(date) && (
        <div className={styles.text_container}>{getDate(date)}</div>
      )}
    </div>
  );
};
