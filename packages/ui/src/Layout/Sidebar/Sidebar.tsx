          ...
          <li>
            <div
              ...
              onClick={() => {
                ...
                const sidebarLabels =
                  document.querySelectorAll(".sidebar_label");
                sidebarLabels.forEach((label) => {
                  label.classList.toggle("sidebar_label_open");
                });
                const sidebarDropicons =
                  document.querySelectorAll(".sidebar_dropicon");
                ...
                subMenuItems.forEach((subMenuItem) => {
                  ...
                  const isOpen =
                    subMenuItem.getAttribute("data-isopen") === "true";
            ...
            >
              <BsArrowLeftRight />
              <div className="sidebar_label">Einklappen</div>
            </div>
          </li>
        </ul>
        <Divider size="none" />
        <div>
          {children && <div className="menu_content_container">{children}</div>}
          <ul className="menu_item_container">
