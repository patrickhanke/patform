...
const SlideInRight = ({children, header, isOpen, setIsOpen, preventClickOutside, size = 'small' }: SlideInRightComponent) => {
	...
	return (
		<>
			...
			<div 
				ref={ref} 
				className={clsx(styles.slidein_container, isOpen === true && styles.is_open)}
				data-size={size}
			>
				{isOpen && 
					<>
