...
import { IconButton, Map, MapPlace, Modal, TableColumnGeopointProps } from '@repo/ui';

const TableColumnGeopoint = ({value, isEditable = false, onChange }: TableColumnGeopointProps) => {
		...
		<>
			...
			>
				<div className={'table_column_textfield_textarea_container'} >
					<Map initialPlace={value} onChange={(geopointer) => setGeopoint(geopointer)} height={300} />
				</div>
			</Modal>
		</>
	);
