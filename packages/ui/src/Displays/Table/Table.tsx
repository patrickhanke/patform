...
const Table: React.FC<TableTypes> = ({ data, columns, rowStyles, cellBorders = false, enableRowSelection = false }) => {
									...
									<th>
										<input
											...
											onChange={(e) => {
												...
												setSelectedRows(isChecked ? new Set(table.getRowModel().rows.map(row => row.id)) : new Set());
											}}
