...
import { ElementSelectInterface, ErrorDisplay, ImageDisplay, SlideIn } from "@repo/ui";
import { Image } from "@repo/types";
import { generateImagePath, useAppContext } from "@repo/provider";

const ImageClassUploader = ({
	previewImage,
	onChange,
	label,
	maxFileCount,
...
export default ImageClassUploader;
