    ...
    }),
    {
      variables: paramsHandler({
        filters: [
          {
            key: "module",
            value: modules.find((module) => module.path === "/location")
              ?.objectId as string,
            operator: "_eq",
            id: "moduleId",
          },
          ...
          {date.place.type === "address" && (
            <div>
              ...
              <input
                ...
                onChange={(e) => changeHandler("place.address", e.target.value)}
              />
            </div>
          )}
          ...
          {date.place.type === "online" && (
            <div>
              ...
              <input
                ...
                onChange={(e) => changeHandler("place.online", e.target.value)}
              />
            </div>
          )}
          {date.place.type === "map" && (
            <div>
              <label>Ort auswählen</label>
              <Map
                initialPlace={date.place.map}
                onChange={(place) => changeHandler("place.map", place)}
              />
            </div>
          )}
        </div>
